# from: https://www.marksayson.com/blog/enabling_regular_expressions_in_sqlite_with_rails/
# adding a regex matched to sqlite so we can use regular expressions in .where clauses
